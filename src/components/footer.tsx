    ...
    <footer className="bg-secondary">
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              Your reliable partner for all plumbing needs.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/location" className="text-muted-foreground hover:text-primary">Service Area</Link></li>
              <li><Link href="/faq" className="text-muted-foreground hover:text-primary">FAQ</Link></li>
              <li><Link href="/contact" className="text-muted-foreground hover:text-primary">Contact Us</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="mb-4 font-semibold text-foreground">Admin</h3>
             <ul className="space-y-2 text-sm">
              <li><Link href="/faq-builder" className="text-muted-foreground hover:text-primary">FAQ Builder</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-muted-foreground">123 Plumbing Ave, New York, NY</span>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="mt-8 border-t pt-6 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} PlumbPro Connect. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
